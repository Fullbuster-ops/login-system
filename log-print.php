...
$generatedDateTime = isset($_POST['generatedDateTime']) ? mysqli_real_escape_string($conn, $_POST['generatedDateTime']) : date('Y-m-d H:i:s'); // Use the provided date or current date as default
